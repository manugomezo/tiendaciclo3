            ...
            <div class="row">
              <div class="col-md-12 min-vh-100 d-flex flex-column justify-content-center">
                <div class="row">
                  <div class="col-lg-6 col-md-8 mx-auto">
                    ...
                    <div class="card rounded shadow shadow-sm">
                      ...
                      <div class="card-body">
                        <form class="form" role="form" autocomplete="off" id="formLogin" novalidate="" action="usuario"
                          method="POST">
                          ...
                          <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-lg rounded-0" name="clave"
                          ...
                          <p align="right">
                            <button type="submit" class="btn btn-primary btn-lg float-right" id="btnLogin">Iniciar
                              sesión</button>
                          </p>
                        </form>
                      </div>
                ...
                <div class="row">
                  ...
                  text-align: center;
                  color: white;
              ">Proyecto tienda genérica</h1>
                  <h2 style="
                  text-align: center;
                  color: white;
              ">misiontic2022 - Universidad El Bosque</h2>
                  <h2 style="
                  text-align: center;
                  color: white;
              ">ciclo 3, grupo 40, equipo 05</h2>
